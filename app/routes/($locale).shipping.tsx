      ...
      <div className="max-w-3xl mx-auto flex flex-col gap-6 sm:gap-8 lg:gap-10 tracking-wider">
        ...
        <div>
          ...
          <ul className="list-disc list-inside space-y-1 !text-sm pl-6">
            ...
            <li>
              Certaines commandes peuvent être liées à plusieurs fournisseurs,
              les articles sont alors envoyés séparément.
            </li>
          </ul>
        </div>
        ...
        <div>
          ...
          <ul className="list-disc list-inside space-y-1 !text-sm pl-6">
            ...
            <p>Livraison standard: 2 à 4 jours ouvrés.</p>
          </ul>
        </div>
        ...
        <div>
          ...
          <p className="!text-sm leading-6 sm:leading-7">
            ...
            par email, vous permettant de suivre l’acheminement de votre colis.
          </p>
        </div>
        ...
        <div className="flex flex-col gap-4">
          ...
          <ul className="list-disc list-inside space-y-1 !text-sm pl-6">
            ...
            <li>
              Remboursements : Une fois que nous aurons reçu et inspecté
              l’article retourné, nous vous enverrons un email pour vous
              confirmer que nous l’avons bien reçu. Nous vous informerons
              également de notre décision quant à l’approbation ou au rejet de
              votre demande de remboursement.
            </li>
            <li>
              Si votre demande est approuvée, alors votre remboursement sera
              traité, et un crédit sera automatiquement appliqué à votre carte
              de crédit ou à votre méthode originale de paiement, dans un délai
              d’un certain nombre de jours.
            </li>
            <li>
              Remboursements en retard ou manquants : Si vous n’avez pas encore
              reçu votre remboursement, veuillez d’abord consulter votre compte
              bancaire à nouveau. Ensuite, contactez l’entité émettrice de votre
              carte de crédit, car il pourrait y avoir un délai avant que votre
              remboursement ne soit officiellement affiché. Si après avoir
              effectué toutes ces étapes, vous n’avez toujours pas reçu votre
              remboursement, veuillez nous contacter à{' '}
              <a
                href={`mailto:${import.meta.env.VITE_CUSTOMER_SUPPORT_EMAIL}`}
                className="underline underline-offset-4"
              >
            ...
            <li>
              Échanges : Nous remplaçons un article seulement s’il est
              défectueux ou endommagé. Si dans ce cas vous souhaitez l’échanger
              contre le même article, envoyez-nous un email à{' '}
              <a
                href={`mailto:${import.meta.env.VITE_CUSTOMER_SUPPORT_EMAIL}`}
                className="underline underline-offset-4"
              >
            ...
            <li>
              ...
              bordereaux de retour. Si vous recevez un remboursement, les frais
              de retour seront déduits de celui-ci.
            </li>
            <li>

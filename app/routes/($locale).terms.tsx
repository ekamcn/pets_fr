      ...
      <div className="max-w-7xl mx-auto flex flex-col gap-10 tracking-wider">
        ...
        <div>
          ...
          <p className="!leading-7">
            ...
            (the "Site"). We are dedicated to providing high-quality e-commerce
            products and services. This document outlines the terms and
            conditions governing your use of our Site.
          </p>
        </div>
        <div>
          <h2 className="!text-2xl font-semibold">Acceptance of Terms</h2>
          <p className="!leading-7">
            By accessing and using our Site, you confirm that you agree to
        ...
        <div>
          ...
          <p className="!leading-7">
            ...
            our Site for personal, non-commercial purposes.
          </p>
        </div>
        <div>
          <h2 className="!text-2xl font-semibold">Definitions</h2>
          <p className="!leading-7 !pb-4">
            To help explain things as clearly as possible in these General Terms
            and Conditions, every time any of these terms are referenced, they
          ...
          <ul className="!list-disc !list-inside text-gray-700 space-y-1">
            ...
            <li>
              ...
              "our," it refers to
              {import.meta.env.VITE_COMPANY_NAME || 'Company Name Not Set'},
              {import.meta.env.VITE_COMPANY_ADDRESS || 'Company Name Not Set'},
              which is responsible for your information under these General
              Terms and Conditions.
            </li>
            <li>
              Country: The location where
              {import.meta.env.VITE_COMPANY_NAME || 'Company Name Not Set'}
            ...
            <li>
              ...
              computer, or any other device that can be used to visit Hollywood
              Feed and use the services.
            </li>
            <li>
              Service: Refers to the services provided by
              {import.meta.env.VITE_COMPANY_NAME || 'Company Name Not Set'}
              as described in the relevant terms (if available) and on this
              platform.
            </li>
            <li>
        ...
        <div>
          ...
          <ul className="!list-disc !list-inside text-gray-700 space-y-1">
            ...
            <li>
              Maintain the security of your account by protecting your password
              and restricting access to your account.
            </li>
            <li>
        ...
        <div>
          ...
          <ul className="!list-disc !list-inside text-gray-700 space-y-1">
            ...
            <li>
              Non-Personal Identification Information: Browser type, device
              type, IP address, pages visited, and time spent on the site.
            </li>
          </ul>
        </div>
        ...
        <div>
          ...
          <p className="!leading-7">
            ...
            within 14 days for returns or exchanges. Products must be returned
        ...
        <div>
          ...
          <p className="!leading-7">
            ...
            consequential damages resulting from your use of the Site or any
        ...
        <div>
          ...
          <p className="!leading-7">
            ...
            {import.meta.env.VITE_COMPANY_NAME || 'Company Name Not Set'}, its
            affiliates, and employees from any claims, losses, liabilities,
            damages, or expenses (including reasonable attorney fees) arising
        ...
        <div>
          ...
          <div className="flex flex-col gap-4">
            <p className="!leading-7">
              ...
              {import.meta.env.VITE_COMPANY_NAME || 'Company Name Not Set'}
              regarding the website shall remain the sole and exclusive property
              of {import.meta.env.VITE_COMPANY_NAME || 'Company Name Not Set'}.
            </p>
            <p className="!leading-7">
              {import.meta.env.VITE_COMPANY_NAME || 'Company Name Not Set'}
        ...
        <div>
          ...
          <p className="!leading-7">
            We've updated our General Terms and Conditions to provide you with
            complete transparency regarding what is set when you visit our site
            and how it's being used. By using our website, registering an
            account, or making a purchase, you hereby consent to our General
            Terms and Conditions.
          </p>
        </div>
        <div>
          ...
          <p className="!leading-7">
            These General Terms and Conditions apply only to the Services. The
            Services may contain links to other websites not operated or
            controlled by
            {import.meta.env.VITE_COMPANY_NAME || 'Company Name Not Set'}. We
            ...
            General Terms and Conditions are no longer in effect. Your browsing
        ...
        <div>
          ...
          <p className="!leading-7">
            ...
            performance and functionality of our website but are non-essential

      ...
      <div className="max-w-3xl mx-auto flex flex-col gap-6 sm:gap-8 lg:gap-10 tracking-wider">
        ...
        <div className="flex flex-col gap-4">
          ...
          <p className="!text-sm leading-6 sm:leading-7">
            ...
            intellectuelle de
            {" "}{import.meta.env.VITE_DOMAIN_NAME}{" "} ou de tiers. L’utilisateur doit
            également s’abstenir de toute utilisation abusive du site, notamment
            en soumettant des contenus illicites, inappropriés, ou portant
            atteinte à la sécurité et à l’intégrité du site.
          </p>
          <p className="!text-sm leading-6 sm:leading-7">

      ...
      <div className="max-w-3xl mx-auto flex flex-col gap-6 sm:gap-8 lg:gap-10 tracking-wider">
        ...
        <div>
          ...
          <p className="!text-sm leading-6 sm:leading-7">
            ...
            utilisateurs du site {import.meta.env.VITE_COMPANY_NAME} l’identité des différents
            intervenants dans le cadre de sa réalisation et de son suivi :
          </p>
          <ul className="list-disc list-inside text-sm space-y-1 mt-2">
            <li>Propriétaire : espritautomoto</li>
            <li>Raison Sociale : CLICKOUTIL SAS</li>
            <li>
              Forme juridique : Société à responsabilité limitée (SARL),
              immatriculée au RCS de Chambery
            </li>
            <li>Business registration : 30337622200053 RCS Paris</li>
            <li>
              Adresse : {import.meta.env.VITE_COMPANY_ADDRESS}H
            </li>
            <li>Téléphone : +33 7 62 43 45 00</li>
            <li>Créateur : {import.meta.env.VITE_COMPANY_NAME}</li>
            <li>
            ...
            <li>Webmaster : Julien – {import.meta.env.VITE_CUSTOMER_SUPPORT_EMAIL}</li>
            <li>
        ...
        <div>
          ...
          <p className="!text-sm leading-6 sm:leading-7">
            L’utilisation du site espritautomoto implique l’acceptation pleine
            ...
            {import.meta.env.VITE_COMPANY_NAME} sont donc invités à les consulter de manière
            régulière.
          </p>
          <p className="!text-sm leading-6 sm:leading-7">
            ...
            toutefois décidée par {import.meta.env.VITE_COMPANY_NAME}, qui s’efforcera alors de
            communiquer préalablement aux utilisateurs les dates et heures de
            l’intervention.
          </p>
          <p className="!text-sm leading-6 sm:leading-7">
            Le site {import.meta.env.VITE_COMPANY_NAME} est mis à jour régulièrement par Bernard.
            De la même façon, les mentions légales peuvent être modifiées à tout
            moment : elles s’imposent néanmoins à l’utilisateur qui est invité à
        ...
        <div>
          ...
          <p className="!text-sm leading-6 sm:leading-7">
            Le site {import.meta.env.VITE_COMPANY_NAME} a pour objet de fournir une information
            concernant l’ensemble des activités de la société.
            {import.meta.env.VITE_COMPANY_NAME} s’efforce de fournir sur le site
            {import.meta.env.VITE_COMPANY_NAME} des informations aussi précises que possible.
          ...
          <p className="!text-sm leading-6 sm:leading-7">
            Toutes les informations indiquées sur le site {import.meta.env.VITE_COMPANY_NAME}
            sont données à titre indicatif, et sont susceptibles d’évoluer. Par
            ailleurs, les renseignements figurant sur le site {import.meta.env.VITE_COMPANY_NAME}
            ne sont pas exhaustifs et sont donnés sous réserve de modifications
        ...
        <div>
          ...
          <p className="!text-sm leading-6 sm:leading-7">
            {import.meta.env.VITE_COMPANY_NAME} est propriétaire des droits de propriété
          ...
          <p className="!text-sm leading-6 sm:leading-7">
            ...
            préalable de {import.meta.env.VITE_COMPANY_NAME}. Toute exploitation non autorisée du
        ...
        <div>
          ...
          <p className="!text-sm leading-6 sm:leading-7">
            {import.meta.env.VITE_COMPANY_NAME} ne pourra être tenue responsable des dommages
            directs et indirects causés au matériel de l’utilisateur, lors de
            l’accès au site {import.meta.env.VITE_COMPANY_NAME}, et résultant soit de
          ...
          <p className="!text-sm leading-6 sm:leading-7">
            {import.meta.env.VITE_COMPANY_NAME} ne pourra également être tenue responsable des
          ...
          <p className="!text-sm leading-6 sm:leading-7">
            ...
            {import.meta.env.VITE_COMPANY_NAME} se réserve le droit de supprimer, sans mise en
            ...
            Le cas échéant, {import.meta.env.VITE_COMPANY_NAME} se réserve également la
        ...
        <div>
          ...
          <p className="!text-sm leading-6 sm:leading-7">
            À l’occasion de l’utilisation du site {import.meta.env.VITE_COMPANY_NAME}, peuvent
            être recueillies : l’URL des liens par l’intermédiaire desquels
            l’utilisateur a accédé au site {import.meta.env.VITE_COMPANY_NAME}, le fournisseur
            d’accès de l’utilisateur, l’adresse de protocole Internet (IP) de
            l’utilisateur.
          </p>
          <p className="!text-sm leading-6 sm:leading-7">
            En tout état de cause, {import.meta.env.VITE_COMPANY_NAME} ne collecte des
            informations personnelles relatives à l’utilisateur que pour le
            besoin de certains services proposés par le site {import.meta.env.VITE_COMPANY_NAME}.
            ...
            est alors précisé à l’utilisateur du site {import.meta.env.VITE_COMPANY_NAME}
          ...
          <p className="!text-sm leading-6 sm:leading-7">
            ...
            {import.meta.env.VITE_COMPANY_NAME} n’est publiée à l’insu de l’utilisateur,
            échangée, transférée, cédée ou vendue sur un support quelconque à
            des tiers. Seule l’hypothèse du rachat de {import.meta.env.VITE_COMPANY_NAME} et de
            ...
            de l’utilisateur du site {import.meta.env.VITE_COMPANY_NAME}.
          </p>
          <p className="!text-sm leading-6 sm:leading-7">
        ...
        <div>
          ...
          <p className="!text-sm leading-6 sm:leading-7">
            Le site {import.meta.env.VITE_COMPANY_NAME} contient un certain nombre de liens
            hypertextes vers d’autres sites, créés avec l’autorisation de
            {import.meta.env.VITE_COMPANY_NAME}. Cependant, {import.meta.env.VITE_COMPANY_NAME} n’a pas la
            possibilité de vérifier le contenu des sites ainsi visités, et
            n’assumera en conséquence aucune responsabilité de ce fait.
          </p>
          <p className="!text-sm leading-6 sm:leading-7">
            La navigation sur le site {import.meta.env.VITE_COMPANY_NAME} est susceptible de
        ...
        <div>
          ...
          <p className="!text-sm leading-6 sm:leading-7">
            ...
            {import.meta.env.VITE_COMPANY_NAME} est soumis au droit français. Il est fait
            attribution exclusive de juridiction aux tribunaux compétents de
            Paris, en cas de litige.
          </p>
        </div>
        ...
        <div>
          ...
          <p className="!text-sm leading-6 sm:leading-7">
            La société {import.meta.env.VITE_COMPANY_NAME} se réserve le droit de modifier, à
            tout moment, ces mentions légales afin de se conformer à toute
            nouvelle législation ou réglementation, ou dans le but d’adapter ces
            mentions à l’évolution de son site. En cas de modification, les
            nouvelles mentions légales seront publiées sur cette page, et elles
            seront considérées comme ayant été acceptées par l’utilisateur en
            cas de consultation du site après la publication des modifications.
          </p>
        </div>
        ...
        <div>
          ...
          <p className="!text-sm leading-6 sm:leading-7">
            ...
            du site {import.meta.env.VITE_COMPANY_NAME}, vous pouvez nous contacter à l’adresse
            suivante :{' '}
            <a href={`mailto:${import.meta.env.VITE_CUSTOMER_SUPPORT_EMAIL}`} className="underline">
            {import.meta.env.VITE_CUSTOMER_SUPPORT_EMAIL}
            </a>
        ...
        <div>
          ...
          <p className="!text-sm leading-6 sm:leading-7">
            {import.meta.env.VITE_COMPANY_NAME} s’engage à promouvoir des pratiques respectueuses
            de l’environnement et du développement durable dans la gestion de
            ses activités. Nous encourageons nos utilisateurs à prendre des
            mesures pour réduire leur empreinte écologique, en particulier lors
            de l’utilisation de nos produits et services.
          </p>
          <p className="!text-sm leading-6 sm:leading-7">
        ...
        <div>
          ...
          <p className="!text-sm leading-6 sm:leading-7">
            {import.meta.env.VITE_COMPANY_NAME} s’efforce de rendre son site accessible à tous
            les utilisateurs, y compris ceux en situation de handicap. Nous
            sommes constamment à la recherche de moyens d’améliorer l’expérience
            de navigation pour tous les visiteurs de notre site.
          </p>
          <p className="!text-sm leading-6 sm:leading-7">
        ...
        <div>
          ...
          <p className="!text-sm leading-6 sm:leading-7">
            En utilisant le site {import.meta.env.VITE_COMPANY_NAME}, l’utilisateur s’engage à ne
            pas violer les droits de propriété intellectuelle de
            {import.meta.env.VITE_COMPANY_NAME} ou de tiers. L’utilisateur doit également
            s’abstenir de toute utilisation abusive du site, notamment en
            soumettant des contenus illicites, inappropriés, ou portant atteinte
            à la sécurité et à l’intégrité du site.
          </p>
          <p className="!text-sm leading-6 sm:leading-7">

            ...
            <div className="relative w-full h-[60vh] sm:h-[70vh] lg:h-[50vh] overflow-hidden">
                {imageUrl ? (
                    <Image
                        ...
                        aspectRatio="16/9"
                        className="w-full !rounded-none h-[60vh] sm:h-[70vh] lg:h-[50vh] object-cover object-center"
                    />
                ) : (
...
export function ImageBannerVariant({
    ...
    return (
        <div className={`relative w-full min-h-screen ${className}`}>
            ...
            {/* Content */}
            <div className={`relative flex flex-col min-h-screen ${layoutStyles[layout]}`}>

...
export type MoneyProductFragment = Pick<
...
> & {
  ...
  variants: {
    edges: Array<{
      node: Pick<StorefrontAPI.ProductVariant, 'id'> & {
...
export type RecommendedProductsPageQueryVariables = StorefrontAPI.Exact<{
  country?: StorefrontAPI.InputMaybe<StorefrontAPI.CountryCode>;
  language?: StorefrontAPI.InputMaybe<StorefrontAPI.LanguageCode>;
}>;

export type RecommendedProductsPageQuery = {
  products: {
    nodes: Array<
...
export type CollectionProductCountQueryVariables = StorefrontAPI.Exact<{
...
export type CollectionProductCountQuery = {
  collection?: StorefrontAPI.Maybe<{
    products: {
      edges: Array<Pick<StorefrontAPI.ProductEdge, 'cursor'>>;
      pageInfo: Pick<StorefrontAPI.PageInfo, 'hasNextPage'>;
    };
  }>;
};

export type CollectionCursorQueryVariables = StorefrontAPI.Exact<{
  handle: StorefrontAPI.Scalars['String']['input'];
...
interface GeneratedQueryTypes {
  ...
  '#graphql\n  fragment RecommendedProduct on Product {\n    id\n    title\n    handle\n    priceRange {\n      minVariantPrice {\n        amount\n        currencyCode\n      }\n    }\n    featuredImage {\n      id\n      url\n      altText\n      width\n      height\n    }\n  }\n  query RecommendedProductsPage ($country: CountryCode, $language: LanguageCode)\n    @inContext(country: $country, language: $language) {\n    products(first: 4, sortKey: UPDATED_AT, reverse: true) {\n      nodes {\n        ...RecommendedProduct\n      }\n    }\n  }\n': {
    return: RecommendedProductsPageQuery;
    variables: RecommendedProductsPageQueryVariables;
  };
